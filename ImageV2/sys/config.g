...
M550 P"DrAlex"                                     ; set printer name
...
M92 X80.00 Y80.00 Z1600.00 E873.00                 ; set steps per mm
...
M574 Z0                                            ; set endstops controlled by probe

; Z-Probe
M307 H7 A-1 C-1 D-1                                ; disable heater on PWM channel for BLTouch
M558 P9 H5 F120 T3600                              ; set Z probe type to bltouch and the dive height + speeds
...
; Tools
M563 P0 D3 H1 F0                                   ; define tool 0
